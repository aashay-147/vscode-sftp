...
export const COMMAND_COMPARE_GROUP_BY_PATH = 'sftp.compare.groupByPath';
export const COMMAND_COMPARE_SHOW_FLAT = 'sftp.compare.showFlat';
export const COMMAND_COMPARE_REVEAL_IN_EXPLORER = 'sftp.compare.revealInExplorer';
export const COMMAND_COMPARE_REVEAL_IN_REMOTE_EXPLORER = 'sftp.compare.revealInRemoteExplorer';
export const COMMAND_COMPARE_DELETE_REMOTE = 'sftp.compare.deleteRemote';
export const COMMAND_COMPARE_DELETE_LOCAL = 'sftp.compare.deleteLocal';
